...
public class P2 {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("----------------------------------");
        System.out.println("The correct errors You should see in orders are:");
        ...
        System.out.println("4:1 ***ERROR*** unterminated string literal with bad escaped character ignored");
        System.out.println("5:1 ***WARNING*** integer literal too large; using max value");
        System.out.println("6:1 ***ERROR*** ignoring illegal character: ^");
        System.out.println("----------------------------------");
        testAllTokens("testErrors");
        CharNum.num = 1;
        System.out.println("----------------------------------");
        testAllTokens("allTokens"); //comprehensive testing
        CharNum.num = 1; 
        System.out.println("The correct errors You should see:");
        System.out.println("1:1 ***ERROR*** unterminated string literal ignored");
        System.out.println("----------------------------------");
        testAllTokens("eof");   //test unterminated string with eof
        CharNum.num = 1; 
